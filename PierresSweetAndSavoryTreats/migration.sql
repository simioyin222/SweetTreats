...
CREATE TABLE `Flavors` (
    ...
    CONSTRAINT `PK_Flavors` PRIMARY KEY (`FlavorId`)
) CHARACTER SET=utf8mb4;

CREATE TABLE `Treats` (
    `TreatId` int NOT NULL AUTO_INCREMENT,
    `Name` longtext CHARACTER SET utf8mb4 NOT NULL,
    CONSTRAINT `PK_Treats` PRIMARY KEY (`TreatId`)
) CHARACTER SET=utf8mb4;
...
CREATE TABLE `TreatFlavors` (
    ...
    CONSTRAINT `PK_TreatFlavors` PRIMARY KEY (`TreatFlavorId`),
...
CREATE INDEX `IX_TreatFlavors_FlavorId` ON `TreatFlavors` (`FlavorId`);

CREATE INDEX `IX_TreatFlavors_TreatId` ON `TreatFlavors` (`TreatId`);

INSERT INTO `__EFMigrationsHistory` (`MigrationId`, `ProductVersion`)
VALUES ('20240301090513_newstuff', '6.0.0');
